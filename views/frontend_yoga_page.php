   ...
   <body onload="onLoad();">
      ...
      <div class="container-fluid">
         ...
         <div class="container-fluid" style="margin-top:10px">
            <div class="row" style="color:black">
               <!--<hr>-->
               <h1 style="width: 100%; text-align: center;font-size:50px;background-color:black;color:white;padding-bottom:5px;">YOGA</h1>
               <!--<hr>-->
      ...
      <script>
         ...
         function loadAllVideos(){
             // All Video
         	var videos = "https://buddytorest.co.uk/php_request?func=yoga";
             ...
             videosRequestXhttp.onload = function() {
             	if (this.readyState == 4 && this.status == 200) {
                     ...
                     if(responseArr)
                     {
                         var fav_videos = "https://buddytorest.co.uk/php_request?func=favyoga&user_id=" + getCookie("user_buddy");
                         	...
                         	if (this.readyState == 4 && this.status == 200) {
                                 ...
                                 if(favresponseArr.length > 0)
                                 {
                                     ...
                                     for(var i =0 ; i < responseArr.length; i++)
                                     {
                                         ...
                                         {
                                             if(responseArr[i].yoga_id == favresponseArr[j].yoga_id)
                                             {
                                                 if(!fav_video.includes(responseArr[i].yoga_id))
                                                 {
                                                     fav_video.push(responseArr[i].yoga_id);
                                                 }
                                             }
                                         }
                                     }
                                     ...
                                     for(var i =0 ; i < responseArr.length; i++)
                                     {
                                         if(fav_video.includes(responseArr[i].yoga_id))
                                         {
                                             console.log("Include - " + responseArr[i].yoga_id);
                                             fav_html_content = fav_html_content + 
                                                 "<div class='col-sm-2' id='Yoga_22' style='margin-bottom:25px;margin-right:25px'>" + 
                                                 "<div style='padding:56.25% 0 0 0;position:relative;'>" + 
                                                 "<iframe src='" + responseArr[i].yoga_url + "' style='position:absolute;top:0;left:0;width:100%;height:100%;' frameborder='0' allow='fullscreen; picture-in-picture' allowfullscreen></iframe>" + 
                                                 "</div>" +
                                                 "<span style='font-size:20px;inline-size: 80%;overflow: hidden;white-space: nowrap;display: inline-block;text-overflow: ellipsis;'>"+ responseArr[i].yoga_title +"</span>" +
                                                 "<i id='next_prev' class='bi bi-heart-fill' style='color:black;font-size:25px;float: right;padding-top:5px;padding-right:5px;' onClick='unsetFavourite("+ responseArr[i].yoga_id +")'></i>" + 
                                                 "</div>";
                                         }
                                         else
                                         {
                                             html_content = html_content + 
                                                 ...
                                                 "</div>" +
                                                 "<span style='font-size:20px;inline-size: 80%;overflow: hidden;white-space: nowrap;display: inline-block;text-overflow: ellipsis;'>"+ responseArr[i].yoga_title +"</span>" +
                                                 "<i id='next_prev' class='bi bi-heart' style='color:black;font-size:25px;float: right;padding-top:5px;padding-right:5px;' onClick='setFavourite("+ responseArr[i].yoga_id +")'></i>" + 
                                                 "</div>";
                                         }
                                     }
                                     ...
                                     if(html_content.length > 0){
                                        calender_title.innerHTML = html_content;
                                         ...
                                         calender_title.innerHTML = "<h2>All yoga videos are favourite</h2>";;
                                     }
                                 ...
                                 else
                                 {
                                     ...
                                     for(var i =0 ; i < responseArr.length; i++)
                                     {
                                         //console.log(responseArr[i].yoga_url);
                                         html_content = html_content + 
                                             "<div class='col-sm-2' id='Yoga_22' style='margin-bottom:25px;margin-right:25px'>" + 
                                             "<div style='padding:56.25% 0 0 0;position:relative;'>" + 
                                             "<iframe src='" + responseArr[i].yoga_url + "' style='position:absolute;top:0;left:0;width:100%;height:100%;' frameborder='0' allow='fullscreen; picture-in-picture' allowfullscreen></iframe>" + 
                                     ...
                                     calender_title.innerHTML = html_content;
                                     var fav_div = document.getElementById("favorites");
                                     fav_div.innerHTML = "<h2>No favourite yoga videos</h2>";
                                 }
                         	}
                         };
             ...
             favvideosRequestXhttp.onload = function() {
             	if (this.readyState == 4 && this.status == 200) {
                     ...
                     if(favresponseArr)
                     {
                         ...
                         {
                             //console.log(favresponseArr[i].yoga_url);
                             var fav_html_content = fav_html_content + 
                                 "<div class='col-sm-2' id='Yoga_22' style='margin-bottom:25px;margin-right:25px'>" + 
                                 "<div style='padding:56.25% 0 0 0;position:relative;'>" + 
                                 "<iframe src='" + favresponseArr[i].yoga_url + "' style='position:absolute;top:0;left:0;width:100%;height:100%;' frameborder='0' allow='fullscreen; picture-in-picture' allowfullscreen></iframe>" + 
                                 "</div>" +
                                 "<span style='font-size:20px;inline-size: 80%;overflow: hidden;white-space: nowrap;display: inline-block;text-overflow: ellipsis;'>"+ favresponseArr[i].yoga_title +"</span>" +
                                 "<i id='next_prev' class='bi bi-heart-fill' style='color:black;font-size:25px;float: right;padding-top:5px;padding-right:5px;' onClick='setFavourite("+ favresponseArr[i].yoga_id +")'></i>" + 
                                 "</div>";
                         }
         ...
         function setFavourite(video_id){
             // Set favourite Video
         	var videos = "https://buddytorest.co.uk/php_request?func=yogaSetFav&user_id=" + getCookie("user_buddy") + "&yoga_id=" + video_id;
             const videosRequestXhttp = new XMLHttpRequest();
             videosRequestXhttp.onload = function() {
             	if (this.readyState == 4 && this.status == 200) {
             		var responseArr = JSON.parse(this.responseText);
         ...
         function unsetFavourite(video_id){
             // Set favourite Video
         	var videos = "https://buddytorest.co.uk/php_request?func=yogaUnsetFav&user_id=" + getCookie("user_buddy") + "&yoga_id=" + video_id;
             const videosRequestXhttp = new XMLHttpRequest();
             videosRequestXhttp.onload = function() {
             	if (this.readyState == 4 && this.status == 200) {
             		var responseArr = JSON.parse(this.responseText);
